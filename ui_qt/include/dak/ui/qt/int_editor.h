...
namespace dak::ui::qt
{
   class int_editor_t : public QWidget
   {
   public:
      typedef std::function<void(int value, bool interacting)> value_changed_callback;
      value_changed_callback value_changed = nullptr;

      int_editor_t(QWidget* parent, const wchar_t* label_text);
      int_editor_t(QWidget* parent, const wchar_t* label_text, int value);
      int_editor_t(QWidget* parent, const wchar_t* label_text, int value, value_changed_callback changed_callback);
