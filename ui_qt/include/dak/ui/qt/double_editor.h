...
namespace dak::ui::qt
{
   class double_editor_t : public QWidget
   {
   public:
      ...
      double_editor_t(QWidget* parent, const wchar_t* label_text);
      double_editor_t(QWidget* parent, const wchar_t* label_text, double value);
      double_editor_t(QWidget* parent, const wchar_t* label_text, double value, value_changed_callback changed_callback);
