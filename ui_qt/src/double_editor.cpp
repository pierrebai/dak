...
namespace dak::ui::qt
{
   ...
   double_editor_t::double_editor_t(QWidget* parent, const wchar_t* label_text)
   : double_editor_t(parent, label_text, NAN, nullptr)
   {
   }

   double_editor_t::double_editor_t(QWidget* parent, const wchar_t* label_text, double value)
   : double_editor_t(parent, label_text, value, nullptr)
   {
   }

   double_editor_t::double_editor_t(QWidget* parent, const wchar_t* label_text, double value, value_changed_callback changed_callback)
   ...
   void double_editor_t::set_limits(double min, double max, double step)
   {
   ...
   void double_editor_t::set_value(double new_value, bool call_callback)
   {
   ...
   void double_editor_t::set_value_from_spin_box(double new_value)
   {
      if (utility::near(current_value, new_value))
         return;
   ...
   void double_editor_t::set_value_from_slider(int new_value, bool force_update)
   {
   ...
   void double_editor_t::set_value_from_slider(int new_value)
   {
      set_value_from_slider(new_value, false);
   }

   void double_editor_t::slider_pressed()
   {
      start_value = slider->value();
   }

   void double_editor_t::slider_released()
   {
      const int new_value = slider->value();
      set_value_from_slider(new_value, start_value != new_value);
   }

   void double_editor_t::build_ui(const wchar_t* label_text)
   {
      ...
      slider->connect(slider, &QSlider::sliderPressed, this, &double_editor_t::slider_released);
      slider->connect(slider, &QSlider::sliderReleased, this, &double_editor_t::slider_released);

      void (QDoubleSpinBox::*vc)(double) = &QDoubleSpinBox::valueChanged;
      text_editor->connect(text_editor, vc, this, &double_editor_t::set_value_from_spin_box);
   }
}
